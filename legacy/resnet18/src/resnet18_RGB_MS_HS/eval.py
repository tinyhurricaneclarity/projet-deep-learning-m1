...
split = torch.load("src/resnet18_RGB_MS_HS/results/split_par_classe_data_augmentation_RGB_MS_HS.pth")
...
best_val_acc = 0.0
best_model_path = "results/best_resnet18_RGB_MS_HS_model.pth"
...
plt.xlabel("Epoch")
plt.ylabel("Loss")
plt.title("Courbe de loss - ResNet18 RGB MS HS")
plt.legend()
plt.grid(True, alpha=0.3)
plt.savefig("loss_resnet18_RGB_MS_HS.png", dpi=150, bbox_inches='tight')
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy (%)")
plt.title("Courbe d'accuracy - ResNet18 RGB MS HS")
plt.legend()
plt.grid(True, alpha=0.3)
plt.savefig("accuracy_resnet18_RGB_MS_HS.png", dpi=150, bbox_inches='tight')
...
plt.savefig("confusion_matrix_resnet18_RGB_MS_HS.png", dpi=150, bbox_inches='tight')
