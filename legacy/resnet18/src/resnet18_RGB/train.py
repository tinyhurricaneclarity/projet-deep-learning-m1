...
for (num_epochs, learning_rate, optimizer_name, scheduler_name, step_size, gamma) in itertools.product(
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(model.state_dict(), "src/resnet18_RGB/results/saved_models/best_loss_train.pth")

    if val_acc > best_val_acc:
        best_val_acc = val_acc
        torch.save(model.state_dict(), "src/resnet18_RGB/results/saved_models/best_acc_train.pth")
