...
path_train = "/net/cremi/leanguye/projet-deep-learning-m1/resnet18/data/beyond-visible-spectrum-ai-for-agriculture-2026/Kaggle_Prepared/train"

class_names = ["Health", "Rust", "Other"]
Num_data    = 600  # 200 images par classe

# Chargement des données
split = torch.load("src/resnet18_RGB_MS/results/split_par_classe_data_augmentation_RGB_MS.pth")
...
best_val_acc = 0.0
best_model_path = "results/best_resnet18_RGB_MS_model.pth"
...
plt.xlabel("Epoch")
plt.ylabel("Loss")
plt.title("Courbe de loss - ResNet18 RGB MS")
plt.legend()
plt.grid(True, alpha=0.3)
plt.savefig("results/loss_resnet18_RGB_MS.png", dpi=150, bbox_inches='tight')
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy (%)")
plt.title("Courbe d'accuracy - ResNet18 RGB MS")
plt.legend()
plt.grid(True, alpha=0.3)
plt.savefig("results/accuracy_resnet18_RGB_MS.png", dpi=150, bbox_inches='tight')

# 3. Matrice de confusion
plt.figure(figsize=(8, 6))
sns.heatmap(conf_matrix, annot=True, fmt='d', cmap='Blues', 
            xticklabels=class_names, yticklabels=class_names)
plt.title(f'Matrice de confusion Resnet18 RGB MS - Test Set\nAccuracy: {test_accuracy:.2f}%')
plt.ylabel('Vraie classe')
plt.xlabel('Classe prédite')
plt.savefig("results/confusion_matrix_resnet18_RGB_MS.png", dpi=150, bbox_inches='tight')
