...
os.makedirs("src/resnet18_RGB_MS/results", exist_ok=True)
torch.save(dico_train_test, "src/resnet18_RGB_MS/results/split_par_classe_data_augmentation_RGB_MS.pth") #dictionnaire {"images": np.array(images), "labels": labels}
...
os.makedirs("src/resnet18_RGB_MS/results/saved_models", exist_ok=True)
...
for (num_epochs, learning_rate, optimizer_name, scheduler_name, step_size, gamma) in itertools.product(
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(model.state_dict(), "src/resnet18_RGB_MS/results/saved_models/best_loss_rgb_ms_data_aug.pth")

    if val_acc > best_val_acc:
        best_val_acc = val_acc
        torch.save(model.state_dict(), "src/resnet18_RGB_MS/results/saved_models/best_acc_rgb_ms_data_aug.pth")
...
df.to_csv("src/resnet18_RGB_MS/results/grid_search_results_par_classe_data_augmentation_RGB_MS.csv", index=False)
print("CSV résultats.")
