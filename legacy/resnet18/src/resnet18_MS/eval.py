...
split = torch.load("src/resnet18_MS/results/split_par_classe_data_augmentation_MS.pth")
...
best_val_acc = 0.0
best_model_path = "results/best_resnet18_MS_model.pth"
...
plt.xlabel("Epoch")
plt.ylabel("Loss")
plt.title("Courbe de loss - ResNet18 MS")
plt.legend()
plt.grid(True, alpha=0.3)
plt.savefig("results/loss_resnet18_MS.png", dpi=150, bbox_inches='tight')
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy (%)")
plt.title("Courbe d'accuracy - ResNet18 MS")
plt.legend()
plt.grid(True, alpha=0.3)
plt.savefig("results/accuracy_resnet18_MS.png", dpi=150, bbox_inches='tight')
print("✓ Courbe d'accuracy sauvegardée dans accuracy_resnet18.png")
...
plt.savefig("results/confusion_matrix_resnet18_MS.png", dpi=150, bbox_inches='tight')
