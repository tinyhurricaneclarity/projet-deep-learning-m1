"""RESNET50 RGB MS 8 canaux total"""
...
class ResNet50(nn.Module): 
    def __init__(self, num_classes=3): #num classes c'est le nombre de classes que va prédire le modèle 
        ...
        self.conv1 = nn.Conv2d(8, 64, kernel_size=7, stride=2, padding=3, bias=False) #input, output (64 features), taille kernel. padding 3 pour avoir 112x112 en sortie
