...
plt.title(f'Matrice de confusion Resnet 18 RGB_MS_HS - Test Set\nAccuracy: {test_accuracy:.2f}%', 
          fontsize=18)
...
plt.savefig("results/confusion_matrix_resnet18_RGB_MS_HS_new.png", dpi=150, bbox_inches='tight')
plt.close()
