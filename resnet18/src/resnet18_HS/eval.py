...
path_train = "/net/cremi/leanguye/projet-deep-learning-m1/resnet18/data/beyond-visible-spectrum-ai-for-agriculture-2026/Kaggle_Prepared/train/HS/"
...
split = torch.load("src/resnet18_HS/results/split_par_classe_data_augmentation_HS.pth")
...
plt.xlabel("Epoch")
plt.ylabel("Loss")
plt.title("Courbe de loss - ResNet18 HS")
plt.legend()
plt.grid(True, alpha=0.3)
plt.savefig("results/loss_resnet18_HS.png", dpi=150, bbox_inches='tight')
print("✓ Courbe de loss sauvegardée dans loss_resnet18.png")
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy (%)")
plt.title("Courbe d'accuracy - ResNet18 HS")
plt.legend()
plt.grid(True, alpha=0.3)
plt.savefig("results/accuracy_resnet18_HS.png", dpi=150, bbox_inches='tight')
print("✓ Courbe d'accuracy sauvegardée dans accuracy_resnet18_HS.png")
