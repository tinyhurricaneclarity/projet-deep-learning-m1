"""
RESNET50 MS -> SE PLACER DANS LE BON DOSSIER DE TRAVAIL(resnet50)
...
os.makedirs("src/resnet50_MS/results", exist_ok=True)
torch.save(dico_train_test, "src/resnet50_MS/results/split_par_classe_MS_50.pth") #dictionnaire {"images": np.array(images), "labels": labels}
...
os.makedirs("src/resnet50_MS/results/saved_models", exist_ok=True)
...
for (num_epochs, learning_rate, optimizer_name, scheduler_name, step_size, gamma) in itertools.product(
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(model.state_dict(), "src/resnet50_MS/results/saved_models/best_loss_MS_data_aug_50.pth")

    if val_acc > best_val_acc:
        best_val_acc = val_acc
        torch.save(model.state_dict(), "src/resnet50_MS/results/saved_models/best_acc_MS_data_aug_50.pth")
