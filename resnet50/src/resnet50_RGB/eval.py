...
split = torch.load("src/resnet50_RGB/results/split_par_classe_RGB_data_aug_50.pth")
...
best_val_acc = 0.0
best_model_path = "results/best_resnet50_RGB_model.pth"
...
plt.xlabel("Epoch")
plt.ylabel("Loss")
plt.title("Courbe de loss - ResNet50 RGB")
plt.legend()
plt.grid(True, alpha=0.3)
plt.savefig("results/loss_resnet50_RGB.png", dpi=150, bbox_inches='tight')
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy (%)")
plt.title("Courbe d'accuracy - ResNet50 RGB")
plt.legend()
plt.grid(True, alpha=0.3)
plt.savefig("results/accuracy_resnet50_RGB.png", dpi=150, bbox_inches='tight')
...
plt.savefig("results/confusion_matrix_resnet50_RGB.png", dpi=150, bbox_inches='tight')
print("✓ Matrice de confusion sauvegardée dans confusion_matrix_resnet50_RGB.png")
