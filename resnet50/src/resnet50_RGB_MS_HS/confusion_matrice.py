...
plt.title(f'Matrice de confusion Resnet 50 RGB MS HS - Test Set\nAccuracy: {test_accuracy:.2f}%', 
          fontsize=18)
...
plt.savefig("results/confusion_matrix_resnet50_RGB_MS_HS_new.png", dpi=150, bbox_inches='tight')
plt.close()
