...
split = torch.load("src/resnet50_RGB_MS_HS/results/split_par_classe_RGB_MS_HS_50.pth")
...
best_val_acc = 0.0
best_model_path = "results/best_resnet50_RGB_MS_HS_model.pth"
...
plt.xlabel("Epoch")
plt.ylabel("Loss")
plt.title("Courbe de loss - ResNet50 RGB MS HS")
plt.legend()
plt.grid(True, alpha=0.3)
plt.savefig("results/loss_resnet50_RGB_MS_HS.png", dpi=150, bbox_inches='tight')
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy (%)")
plt.title("Courbe d'accuracy - ResNet50 RGB_MS_HS")
plt.legend()
plt.grid(True, alpha=0.3)
plt.savefig("results/accuracy_resnet50_RGB_MS_HS.png", dpi=150, bbox_inches='tight')
...
plt.title(f'Matrice de confusion Resnet50 RGB MS HS - Test Set\nAccuracy: {test_accuracy:.2f}%')
plt.ylabel('Vraie classe')
plt.xlabel('Classe prédite')
plt.savefig("results/confusion_matrix_resnet50_RGB_MS_HS.png", dpi=150, bbox_inches='tight')
