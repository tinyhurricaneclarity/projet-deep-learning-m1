"""
RESNET50 HS -> SE PLACER DANS LE BON DOSSIER DE TRAVAIL(resnet50)
...
os.makedirs("src/resnet50_HS/results/saved_models", exist_ok=True)
...
for (num_epochs, learning_rate, optimizer_name, scheduler_name, step_size, gamma) in itertools.product(
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(model.state_dict(), "src/resnet50_HS/results/saved_models/best_loss_HS_data_aug_50.pth")

    if val_acc > best_val_acc:
        best_val_acc = val_acc
        torch.save(model.state_dict(), "src/resnet50_HS/results/saved_models/best_acc_HS_data_aug_50.pth")
...
df.to_csv("src/resnet50_HS/results/grid_search_results_par_classe_HS_50.csv", index=False)
print("CSV résultats.")
