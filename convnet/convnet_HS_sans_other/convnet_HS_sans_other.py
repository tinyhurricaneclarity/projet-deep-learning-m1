# convnet_HS_sans_other.py
# ConvNet from scratch sur images HS 32x32 - classification binaire Health vs Rust
...
class ConvNet(nn.Module):
    ...
    125 canaux en entrée (HS), 2 classes en sortie.
    """
...
for epoch in range(1, num_epochs + 1):
    ...
    if val_loss < best_val_loss:
        ...
        epochs_sans_amelioration = 0
        torch.save(model.state_dict(), "saved_models/convnet_HS_sans_other_best.pth")
...
model.load_state_dict(torch.load("saved_models/convnet_HS_sans_other_best.pth"))
...
plt.xlabel("Epoch")
plt.ylabel("Loss")
plt.title("Courbe de loss - ConvNet HS sans Other")
plt.legend()
plt.savefig("loss_convnet_HS_sans_other.png")
print("Courbe de loss sauvegardée dans loss_convnet_HS_sans_other.png")
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy")
plt.title("Courbe d'accuracy - ConvNet HS sans Other")
plt.legend()
plt.savefig("accuracy_convnet_HS_sans_other.png")
print("Courbe d'accuracy sauvegardée dans accuracy_convnet_HS_sans_other.png")
