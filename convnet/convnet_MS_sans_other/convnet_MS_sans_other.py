# convnet_MS_sans_other.py
# ConvNet from scratch sur images MS 64x64 - classification binaire Health vs Rust
# La classe Other est retirée pour tester si les performances s'améliorent sans la confusion apportée par cette classe hétérogène

# Améliorations apportées :
# - Data augmentation dynamique (flips, rotation)
# - Tirage au sort à l'intérieur de chaque classe pour l'équilibre
# - Val : 66 images (33 par classe), Test : 66 images (33 par classe)
...
def alea_train_test(Num_data, class_names, n_val=66, n_test=66):
...
class ConvNet(nn.Module):
    ...
    Classification binaire : Health vs Rust (Other retiré).
    5 canaux en entrée (MS), 2 classes en sortie.
    """
    def __init__(self, num_classes=2):
        ...
        self.fc2 = nn.Linear(256, num_classes)  # 2 classes : Health et Rust
...
class_names = ["Health", "Rust"]  # Other retiré
Im_type     = "MS"
Num_data    = 400  # 200 Health + 200 Rust uniquement
...
for epoch in range(1, num_epochs + 1):
    ...
    if val_loss < best_val_loss:
        ...
        epochs_sans_amelioration = 0
        torch.save(model.state_dict(), "saved_models/convnet_MS_sans_other_best.pth")
...
model.load_state_dict(torch.load("saved_models/convnet_MS_sans_other_best.pth"))
...
plt.xlabel("Epoch")
plt.ylabel("Loss")
plt.title("Courbe de loss - ConvNet MS sans Other")
plt.legend()
plt.savefig("loss_convnet_MS_sans_other.png")
print("Courbe de loss sauvegardée dans loss_convnet_MS_sans_other.png")
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy")
plt.title("Courbe d'accuracy - ConvNet MS sans Other")
plt.legend()
plt.savefig("accuracy_convnet_MS_sans_other.png")
print("Courbe d'accuracy sauvegardée dans accuracy_convnet_MS_sans_other.png")
